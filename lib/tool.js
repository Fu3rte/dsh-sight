// The `vision` tool: raw JSON-Schema definition; reads config through a
// thunk on every call so hot-reloaded settings apply immediately.
...
export function buildVisionTool(getConfig, toolName) {
  return {
    ...
    timeoutMs: deriveConfig(getConfig()).timeoutMs + 30_000,

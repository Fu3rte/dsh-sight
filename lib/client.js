...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const CLIENT_PRESETS = {
      'opencode-zen': { label: 'OpenCode Zen（免费层，免 key）', model: 'mimo-v2.5-free', baseUrl: 'https://opencode.ai/zen/v1', keyless: true, keyEnv: null },
      'gemini-flash': { label: 'Gemini Flash — Google AI Studio（免费额度，需注册 key）', model: 'gemini-3.6-flash', baseUrl: 'https://generativelanguage.googleapis.com/v1beta/openai', keyless: false, keyEnv: 'GEMINI_API_KEY' },
    }

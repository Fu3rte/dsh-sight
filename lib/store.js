// Image landing store for pasted images: bytes land in /tmp/dsh-sight/
// image{N}/{hash}.{ext} and a hint text carries the path to the `vision`
// tool. MD5 dedup, stable per-image sequence numbers, LRU cap (maxImages).
...
function hintForPath(filePath, seq) {
